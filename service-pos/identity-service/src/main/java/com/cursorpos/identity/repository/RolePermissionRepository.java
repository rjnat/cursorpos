...
public interface RolePermissionRepository extends JpaRepository<RolePermission, UUID> {
    ...
    List<UUID> findPermissionIdsByRoleIdAndTenantId(@Param("roleId") UUID roleId, @Param("tenantId") String tenantId);
    ...
    List<UUID> findPermissionIdsByRoleIdsAndTenantId(@Param("roleIds") List<UUID> roleIds,
